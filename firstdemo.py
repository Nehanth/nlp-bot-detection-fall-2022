...
df = pd.read_csv('/Users/nehanthnarendrula/Downloads/Twitter Bot/CleanDataSet.csv', encoding="latin-1")
df.isnull()
df.isnull().sum().sum()
...
FILE_NAME = '/Users/nehanthnarendrula/Downloads/Twitter Bot/last_seen.txt'
